...
the Site OS community a harassment-free experience for everyone, regardless of
...
Issues and pull requests, and when an individual is officially representing the
...
- **Private report:** [GitHub Security Advisory](https://github.com/AgriciDaniel/site-os/security/advisories/new)
...
Project maintainers will follow these Community Impact Guidelines when deciding
...
**3. Temporary ban:** A temporary ban from public interaction with the
community for a specified period of time.

**4. Permanent ban:** A permanent ban from public interaction within the
community.
